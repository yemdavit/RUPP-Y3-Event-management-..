document.addEventListener("DOMContentLoaded", () => {
  ...
  const names = document.querySelectorAll(".carousel .name"); // Target names
  let currentIndex = 0;
  ...
  function updateCarousel() {
    ...
    names.forEach((name, index) => {
      if (index === currentIndex) {
        ...
        name.style.transform = index > currentIndex ? "translateY(100%)" : "translateY(-100%)";
  ...
  // Function to move the thumbnail container left by 275px
